...
class PalleteDark {
  ...
  static const Color gradientToColor = Color.fromRGBO(43, 94, 229, 1);
  static const Color gradientFromColor = Color.fromRGBO(239, 99, 230, 1);
...
class PalleteLight {
  ...
  static const Color gradientToColor = Color(0xffEDF6F9);
  static const Color gradientFromColor = Color(0xffF3F3F3);
